...
package com.pandeagames.www.gutterballredux;
...
public class AndroidDebugDraw extends DebugDraw {
    ...
    public Canvas mCanvas = new Canvas(mBitmap);
...
/*
	...
	*/
	...
	public AndroidDebugDraw(IViewportTransform transform) {	
		super(transform);
		screen = this;
		//g = pApplet;
...
*/
	...
	public void drawPolygon(Vec2[] vertices, int vertexCount, Color3f color) {
		for (int i = 0; i < vertexCount; ++i) {
			...
			mCanvas.drawLine(v1.x*100, v1.y*100, v2.x*100, v2.y*100, mPaint);
		}
